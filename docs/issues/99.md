...
### 评论 156 - leouid
已通过Docker在NAS上部署成功，有新的版本后要怎么更新？？
---
...
同问！我也部署在自己的NAS上，现在有新的版本，请问要怎么升级？？？
---

### 评论 159 - github-0xffff
将NAS上xiaomusic路径下的mp3下载到Windows电脑上用potplayer播放，提示【无法获取 音频|视频 信息。(不支持播放加密媒体)】，原存放在该Windows电脑上的同一个mp3正常播放。请问此是否为正常情况？
---

### 评论 160 - ygllong
新版本还需要添加一些环境变量吗？如小米账号等？我没有添加，后台也能上，后台有音乐列表，可是点播放没有声音，语音让音箱播放时说不能下载本地音乐，申明问题呢？谢谢
---
