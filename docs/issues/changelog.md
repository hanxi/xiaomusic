...
- 增加搜索多结果选择功能 (#864)
- 新增小爱音箱语音反馈，及后端检测播放url有效性 (#863)
- 新增语音口令搜索歌单功能 (#856)
- 新增语音口令搜索歌单功能 (#855)
- **api**: 优化音乐信息获取接口，解除TailWind主题下仅支持mp3文件播放的限制 (#852)
- 增强OGG封面解析，支持FLAC二进制结构的metadata_block_picture (#851)
- 支持自定义temp_path路径，临时文件不再依赖music_path挂载 (#850)
- 前端新增MusicFree搜索歌单功能 (#849)
- 后端增加MusicFree的搜索歌单功能 (#848)
- 增加免签发Web App功能，三种添加桌面方式，及优缺点说明。修复遗留的若干bug。 (#846)
- 针对LX Server接口，增加搜索歌单功能 (#842)
- 默认播放页面，新增快进快退按钮，新增倍速播放，点击进度条快进快退，调整样式。(#840)

### Fix

- lint
- 修复某些MusicFree插件，从歌单获取的歌曲数不完整 (#859)
- 修复不同歌单，不同url，但歌曲名字一样，后台播放会混淆的问题 (#857)
- 修复LX歌单转XiaoMusic歌单，转换后某些平台无法播放的问题 (#839)
