...
L07A测试失败
```
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:864: 开始播放列表B站测试歌单 晴天
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:240: play_internal. search_key: name:晴天 allow_download:True
[2026-03-25 19:54:58] [0.4.26] [INFO] music_library.py:591: 根据【晴天】找到歌曲【['晴天']】
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:250: play_internal. names:['晴天'] 1
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:924: cancel_group_next_timer {'***********': <xiaomusic.device_player.XiaoMusicDevice object at 0x7fa63cbdf0>}
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:909: cancel_next_timer did: ***********
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:919: 下一曲定时器不见了 did: ***********
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:344: cur_music 晴天
[2026-03-25 19:54:58] [0.4.26] [INFO] music_library.py:1072: get_music_url name:晴天
[2026-03-25 19:54:58] [0.4.26] [INFO] music_library.py:1086: in _get_web_music_url
[2026-03-25 19:54:58] [0.4.26] [INFO] music_library.py:1088: get_music_url web music. name:晴天, url:https://www.bilibili.com/video/BV1U44y1G7a6
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:884: group_force_stop_xiaoai Redmi小爱音箱Play-2 ['***********']
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:420: force_stop_xiaoai player_pause device_id:*********** ret:{'code': 0, 'message': "Msg has been successfully proxy to the device, this service is a simple proxy, if you encounter any problems pls contact ROM's developers directly!!!", 'data': {'code': 0}}
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:432: {'code': 0, 'message': "Msg has been successfully proxy to the device, this service is a simple proxy, if you encounter any problems pls contact ROM's developers directly!!!", 'data': {'code': 0, 'info': '{ "status": 1, "volume": 42, "loop_type": 1 }'}}
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:446: stop_if_xiaoai_is_playing player_stop device_id:*********** enable_force_stop:False ret:{'code': 0, 'message': "Msg has been successfully proxy to the device, this service is a simple proxy, if you encounter any problems pls contact ROM's developers directly!!!", 'data': {'code': 0}}
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:887: group_force_stop_xiaoai ['***********'] [None]
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:347: 播放 https://www.bilibili.com/video/BV1U44y1G7a6
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:725: play_one_url play_by_url device_id:*********** ret:{'code': 0, 'message': "Msg has been successfully proxy to the device, this service is a simple proxy, if you encounter any problems pls contact ROM's developers directly!!!", 'data': {'code': 0}} url:https://www.bilibili.com/video/BV1U44y1G7a6
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:699: group_player_play https://www.bilibili.com/video/BV1U44y1G7a6 ['***********'] [{'code': 0, 'message': "Msg has been successfully proxy to the device, this service is a simple proxy, if you encounter any problems pls contact ROM's developers directly!!!", 'data': {'code': 0}}]
[2026-03-25 19:54:58] [0.4.26] [INFO] device_player.py:364: 【晴天】已经开始播放了
[2026-03-25 19:54:58] [0.4.26] [INFO] music_library.py:1086: in _get_web_music_url
[2026-03-25 19:54:58] [0.4.26] [INFO] music_library.py:1088: get_music_url web music. name:晴天, url:https://www.bilibili.com/video/BV1U44y1G7a6
[2026-03-25 19:54:59] [0.4.26] [INFO] music_utils.py:220: 待执行的完整命令 ffprobe command: ./ffmpeg/bin/ffprobe -v error -show_entries format=duration -of json /tmp/tmp7emlg7um
[2026-03-25 19:54:59] [0.4.26] [INFO] music_utils.py:231: 命令执行结果 command result - return code: 1, stdout: {
/tmp/tmp7emlg7um: Invalid data found when processing input

}

[2026-03-25 19:54:59] [0.4.26] [WARNING] music_utils.py:245: Error getting local music /tmp/tmp7emlg7um duration: Expecting property name enclosed in double quotes: line 2 column 1 (char 2)
[2026-03-25 19:54:59] [0.4.26] [WARNING] music_utils.py:198: Error getting local music /tmp/tmp7emlg7um duration: 'NoneType' object has no attribute 'info'
[2026-03-25 19:54:59] [0.4.26] [INFO] music_library.py:838: 网络音乐 晴天 时长: 0 秒
[2026-03-25 19:54:59] [0.4.26] [INFO] analytics.py:78: analytics run_with_cancel success
[2026-03-25 19:54:59] [0.4.26] [INFO] device_player.py:377: 【晴天】不会设置下一首歌的定时器
```
---
